...
public class TestTraSach {
    ...
    private static void addPhieuMuon() {
        try(ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream("phieumuon.dat"))) {
            ...
            calendar.set(2023, 2, 5);
            Date date2 = calendar.getTime();
            
            calendar.set(2023, 1, 30);
            ...
            /////////////////////////////////////
            Sach sach4 = Sach.getSach("B011");
            Sach sach5 = Sach.getSach("B012");
            ...
            /////////////////////////////////////
            Sach sach6 = Sach.getSach("B013");
            Sach sach7 = Sach.getSach("B014");
            Sach sach8 = Sach.getSach("B015");
            ArrayList<Sach> sachs3 = new ArrayList<>();
            sachs3.add(sach6);
            sachs3.add(sach7);
            sachs3.add(sach8);

            calendar.set(2023, 2, 27);
            Date ngayMuon3 = calendar.getTime();
            calendar.add(Calendar.DAY_OF_MONTH, 30);
            Date ngayPhaiTra3 = calendar.getTime();
            
            ArrayList<Date> ngayTra3 = new ArrayList<>();
            ngayTra3.add(null);
            ngayTra3.add(null);
            ngayTra3.add(null);
            
            ArrayList<String> trangThai3 = new ArrayList<>();
            trangThai3.add(null);
            trangThai3.add(null);
            trangThai3.add(null);
            
            PhieuMuon phieuMuon3 = new PhieuMuon("3", docGia, sachs3, ngayMuon3, ngayPhaiTra3, ngayTra3, trangThai3);
            ////////
            
            phieuMuons.add(phieuMuon1);
            phieuMuons.add(phieuMuon2);
            phieuMuons.add(phieuMuon3);            
